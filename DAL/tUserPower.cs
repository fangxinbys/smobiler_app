...
namespace Maticsoft.DAL
{
	...
	public partial class tUserPower
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("upId", "tUserPower"); 
		}
		...
		public bool Exists(int upId)
		{
			...
			strSql.Append("select count(1) from tUserPower");
		...
		public bool Delete(int upId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tUserPower ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select upId,userId,powerId ");
			strSql.Append(" FROM tUserPower ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" upId,userId,powerId ");
			strSql.Append(" FROM tUserPower ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tUserPower T ");
