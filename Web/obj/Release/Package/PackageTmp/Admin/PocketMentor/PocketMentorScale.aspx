    ...
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="10px" runat="server">
            ...
            <Rows>
                <f:FormRow>
                    <Items>
                        <f:NumberBox ID="txtSf" Label="拜师师傅赏金" Required="true" ShowRedStar="true" runat="server" EmptyText="请输入数字" Text="4" />

                    </Items>
                </f:FormRow>
                <f:FormRow>
                    <Items>
                        <f:NumberBox ID="txtTd" Label="拜师徒弟赏金" Required="true" ShowRedStar="true" runat="server" EmptyText="请输入数字" Text="3" />

                    </Items>
                </f:FormRow>
                <f:FormRow>
                    <Items>
                        <f:NumberBox ID="txtTx" Label="会员提现限额" Required="true" ShowRedStar="true" runat="server" EmptyText="请输入数字" Text="10" />

                    </Items>
                </f:FormRow>
                <f:FormRow>
                    <Items>
                        <f:NumberBox ID="txtBl" Label="上级抽成比例" Required="true" ShowRedStar="true" runat="server" EmptyText="请输入数字" Text="10" />
