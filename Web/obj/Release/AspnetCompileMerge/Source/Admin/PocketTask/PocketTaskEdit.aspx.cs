...
namespace Maticsoft.Web.Admin.PocketTask
{
    public partial class PocketTaskEdit : PageBase
    {
        ...
        {
            Maticsoft.BLL.tSet bllSet = new Maticsoft.BLL.tSet();
            Maticsoft.Model.tSet modelSet = bllSet.GetModel(1);
            Maticsoft.BLL.PocketTask bll = new Maticsoft.BLL.PocketTask();
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["Id"]))
            {
                ...
                model.pocketTaskRuleUrl = modelSet.Domain + "showTask.aspx?Id=" + model.pocketTaskId;
                bll.Update(model);
            ...
            else
            {
                ...
                modelUp.pocketTaskRuleUrl = modelSet.Domain + "showTask.aspx?Id=" +k;
                bll.Update(modelUp);
                if (k > 0)
                {
                    PageContext.RegisterStartupScript(ActiveWindow.GetHidePostBackReference());
